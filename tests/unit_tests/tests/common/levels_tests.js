...
describe("Levels", function() {
	...
	describe("Function is_api_undefined", function() {
		...
		it("should return True or False",function() {
			...
			expect(is_api_undefined("window.Worker") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("window.SharedArrayBuffer") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("window.DataView") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("window.Uint8Array") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("window.Int8Array") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("window.Uint8ClampedArray") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("window.Int16Array") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("window.Uint16Array") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("window.Int32Array") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("window.Uint32Array") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("window.Float32Array") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("window.Float64Array") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("window.XMLHttpRequest") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("navigator.hardwareConcurrency") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("navigator.deviceMemory") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("CanvasRenderingContext2D.prototype.getImageData") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("HTMLCanvasElement.prototype.toBlob") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("HTMLCanvasElement.prototype.toDataURL") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("Performance.prototype.now") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("PerformanceEntry.prototype") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
			expect(is_api_undefined("window.Date") === true || is_api_undefined("navigator.getBattery") === false).toBeTruthy();
		});
		it("should throw error when parametr is not given",function() {
