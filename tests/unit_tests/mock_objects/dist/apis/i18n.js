        ...
        fakeApi(browser) {
            const _i18n = {
                getMessage: (messageName, substitutions = []) => {
                    ...
                    if (_uiLanguageRegionless !== _uiLanguage &&
