import { BrowserMock, Alarms, ContextualIdentities, Cookies, Extension, I18n, Runtime, Storage, Tabs, Windows } from 'webextensions-api-mock';
...
export interface TabsFake extends Tabs {
    ...
    _redirect: (tabId: any, fakeRedirects: any, fakeWebRequest?: any) => Promise<any>;
