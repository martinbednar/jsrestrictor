        ...
        fakeApi(browser) {
            const contextualIdentities = {
                ...
                async remove(cookieStoreId) {
                    const containerIndex = _containers.findIndex(container => container.cookieStoreId === cookieStoreId);
                    if (containerIndex === -1) {
                ...
                async update(cookieStoreId, details) {
                    const containerIdx = _containers.findIndex(container => container.cookieStoreId === cookieStoreId);
                    if (containerIdx === -1) {
            ...
            browser.contextualIdentities.update.callsFake(contextualIdentities.update);
